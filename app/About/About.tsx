    ...
    <div>
      ...
      <section className={AboutStyles.aboutContainer}>
        <div className={AboutStyles.aboutDiv}>
          ...
          <p>
            ...
            development has been a passion of mine for over two years now, focusing
            more on the front-end, but also exploring other aspects.
            <br />
            <br />
            <span className={AboutStyles.firstLetter}>M</span>y goal is to
            improve each day and learn something new all while attempting to land a new job. With the help of{" "}
            <a
            ...
            veterans in the development field, I am working alongside leaders in the industry to help me grow and succeed. Be sure to check out my{" "} 
            <a className={AboutStyles.vwcTag}
               href="/projects"
               target="_blank"
               rel="noopener noreferrer">
                projects
      ...
      <section className={AboutStyles.cohortSection}>
        ...
        <p>
          ...
          <br />
          <br />
          <span className={AboutStyles.firstLetter}>W</span>ith my
          cohort, we were all a part of the first online cohort for Vets Who
          Code. Throughout the program, I learned a lot about version control,
          working with others/asking for help, creating and consuming RESTful
          API data with NextJS/NodeJS/React/& TypeScript, and more.
          <br />
          <br />
          <span className={AboutStyles.firstLetter}>C</span>ompleting the cohort
          was a very rewarding experience. From styling my basic static portfolio page with
          HTML, CSS, and vanilla JS, to migrating now using Next.js/Node.js/React.js/&
          ...
          work and continue building on my skills. Please check out my{" "}
          <a className={AboutStyles.vwcTag}
